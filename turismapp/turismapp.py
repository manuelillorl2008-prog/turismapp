...
class AdminState(rx.State):
    ...
    def cargar_datos(self):
        try:
            r = httpx.get("http://localhost:8001/reservas")
            self.reservas = r.json()["data"]
        except:
            self.reservas = []
        try:
            s = httpx.get("http://localhost:8001/sugerencias")
            self.sugerencias = s.json()["data"]
        except:
            self.sugerencias = []
        try:
            o = httpx.get("http://localhost:8001/ofertas")
            self.ofertas = o.json()["data"]
        except:
            self.ofertas = []

    def confirmar_reserva(self, reserva_id: int):
        try:
            httpx.put(f"http://localhost:8001/reservas/{reserva_id}/estado?estado=confirmada")
            self.cargar_datos()
        except:
            pass
    ...
    def cancelar_reserva(self, reserva_id: int):
        try:
            httpx.put(f"http://localhost:8001/reservas/{reserva_id}/estado?estado=cancelada")
            self.cargar_datos()
        except:
            pass
    ...
    def eliminar_reserva(self, reserva_id: int):
        try:
            httpx.delete(f"http://localhost:8001/reservas/{reserva_id}")
            self.cargar_datos()
        except:
            pass
    ...
    def eliminar_sugerencia(self, sug_id: int):
        try:
            httpx.delete(f"http://localhost:8001/sugerencias/{sug_id}")
            self.cargar_datos()
        except:
            pass
    ...
    def eliminar_oferta(self, oferta_id: int):
        try:
            httpx.delete(f"http://localhost:8001/ofertas/{oferta_id}")
            self.cargar_datos()
        except:
            pass
    ...
    def crear_oferta(self):
        if not self.of_nombre or not self.of_descripcion or not self.of_precio:
            ...
            return
        try:
            r = httpx.post("http://localhost:8001/ofertas", json={
